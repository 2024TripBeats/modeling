...
travle_score = pd.read_csv('/root/TripBeats_modeling-repo/music/output/KoSimCSE-roberta2/standardized_results.csv')
...
# 오전 점수 저장
morning_df.to_csv('/root/TripBeats_modeling-repo/music/pipeline/data/morning_score_id.csv', index=True)

# 오후 점수 저장
afternoon_df.to_csv('/root/TripBeats_modeling-repo/music/pipeline/data/afternoon_score_id.csv', index=True) 

# 밤 점수 저장
night_df.to_csv('/root/TripBeats_modeling-repo/music/pipeline/data/night_score_id.csv', index=True)
